...
import { fetchTransactionsForLedger } from "@/app/lib/read";

export default async function LedgerTable({id}:{id:number}){
    // const dashBoardTransactions=await fetchTransactionsForLedger({id:id});
    return(
        <>Ledger Table</>
    )
    // return(
